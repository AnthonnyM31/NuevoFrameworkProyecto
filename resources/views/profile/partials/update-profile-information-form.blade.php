<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-4">
        ...
        <div class="mb-3">
            ...
            <x-text-input id="name" name="name" type="text" class="mt-1 d-block w-100" :value="old('name', $user->name)"
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && !$user->hasVerifiedEmail())
                <div class="mt-2">
                    <p class="text-sm text-dark">
                        ...
                        <button form="send-verification" class="btn btn-link p-0 text-decoration-none small align-baseline">
